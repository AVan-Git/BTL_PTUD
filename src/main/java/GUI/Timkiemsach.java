 ...
 * @author LENOVO
 */
public class Timkiemsach extends JFrame implements ActionListener {
...
//    
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(Timkiemsach.class.getName()).log(java.util.logging.Level.SEVERE, null,
					ex);
